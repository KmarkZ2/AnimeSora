...
//       }}
//     >
//       <div className="relative md:w-[529px] w-[264] flex-1 overflow-hidden">
//         <Image src={card.image} alt={"Image"} fill className={`object-cover rounded-l-[10px] ${card.className}`} />
...
//           <h2
//             className={"font-[Orbitron] font-bold md:text-[1.5rem] text-[1rem] p-[0px] text-center"}
...
//             <Button text={"Watch →"} bgColor={"#225EB8"} onClick={() => {}}></Button>
//           </Link>
//         </div>
//       </div>
//     </div>
